...
#ifdef VENDOR_EDIT
/* Jun.Wei@BSP.CHG.Basic, 2019/07/02, Add for charging */
...
#ifdef ODM_WT_EDIT
/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic.1941873, 20191206, Add for ARB */
...
#ifdef ODM_WT_EDIT
	/* Jie.Huang@ODM_WT.BSP.Charger.Basic.1941873, 20191014, Add CDP ICL when connected */
