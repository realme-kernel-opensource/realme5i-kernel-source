...
int set_oppo_display_vendor(const char * display_name) {
    ...
    if (!strcmp(display_name,"dsi_samsung_fhd_plus_dsc_cmd_display")) {
        ...
        oppo_display_vendor = OPPO_SAMSUNG_S6E3FC2X01_DISPLAY_FHD_DSC_CMD_PANEL;
        register_device_proc("lcd", "S6E3FC2X01", "samsung1024");
    } else if ((!strcmp(display_name,"dsi_ili9881h_truly_auo_video_display")) || (!strcmp(display_name,"dsi_ili9881h_truly_auo_gg3_video_display"))) {
    ...
    } else if ((!strcmp(display_name,"dsi_nt36525b_hlt_boe_video_display")) || (!strcmp(display_name,"dsi_nt36525b_hlt_boe_gg3_video_display"))) {
